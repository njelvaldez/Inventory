...
Public Class frmInventoryReportSales
    Private RemoteDataSet As New DataSet
    Private TradeInventoryReport As String = System.Configuration.ConfigurationSettings.AppSettings.Item("TradeInventoryReportSales")
    ...
    Private Sub frmInventoryReportSales_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub GenerateInventory()
        ...
        If IsValidOptions() Then
            ...
            GetAndUpdateSales(fromdate, todate, itemdesc, Convert.ToInt16(txtPercentFactor.Text))
