...
Public Class frmAdjustmentReport
    ...
    Private AdjustmentReport As String = System.Configuration.ConfigurationSettings.AppSettings.Item("AdjustmentReport")
    ...
    Private Sub SetPath()
        ...
        txtTemplate.Text = AdjustmentReport
        txtOutput.Text = AdjustmentReport.Replace(".xlsx", currentdate + ".xlsx")
    End Sub

    Private Sub frmAdjustmentReport_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub InventoryReportShow()
        Try
            ...
            BusinessObject.Sub_Show(ServerPath2, "AdjustmentReportSelect", CommandType.StoredProcedure, RemoteDataSet, "ProductFormCT_Show")
    ...
    Private Sub ExportInventoryReport(ByVal strFileName As String)
        ...
        Try
            ...
            For Each dr As DataRow In dt.Rows
                'Adjno
                strArr(rownumber, 0) = dr("Adjno").ToString
                'htr.AdjDate
                strArr(rownumber, 1) = dr("AdjDate").ToString
                'dtr.ItemCode
