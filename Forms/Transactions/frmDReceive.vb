...
Public Class frmDReceive
    ...
    Private Sub cmdEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdEdit.Click
        ...
        '    txtQty.Focus()
        'End If
        MsgBox("Update of Received Inventory is not allowed!")
    End Sub
    ...
    Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        ...
        If EditMode = False Then
            If AllValidFields() Then
                Sub_Insert()
                'Update Stkcard IMS Received Inventory
                StkcardIMSReceive(txtLocCode.Text, txtItemCode.Text, txtLotNo.Text, dtexpdate.Value, txtQty.Text)
            Else
    ...
    Private Function AllValidFields() As Boolean
        ...
        If txtRecNo.Text.ToString <> "" And txtLocCode.Text.ToString <> "" And _
    ...
    Private Sub Sub_Insert()
        Try
            ...
            Dim HRID As New SqlParameter("@HRID", SqlDbType.Int, 10) : HRID.Direction = ParameterDirection.Input : HRID.Value = Convert.ToInt16(txtHRID.Text) : Params(0) = HRID
            ...
            BusinessObject.Sub_Insert(ServerPath2, "DReceive_Insert", CommandType.StoredProcedure, Params)
            LogHelper.InsertLog("DReceive_Insert")
        Catch ex As Exception
            MsgBox(ex.Message)
            LogHelper.InsertLog("DReceive_Insert.Error: " & ex.Message)
        End Try
    ...
    Private Sub Sub_Update()
        ...
        '    Dim HRID As New SqlParameter("@HRID", SqlDbType.Int, 10) : HRID.Direction = ParameterDirection.Input : HRID.Value = txtHRID.Text : Params(0) = HRID
        '    Dim LOCCODE As New SqlParameter("@LOCCODE", SqlDbType.VarChar, 5) : LOCCODE.Direction = ParameterDirection.Input : LOCCODE.Value = txtLocCode.Text : Params(1) = LOCCODE
        '    Dim ITEMCODE As New SqlParameter("@ITEMCODE", SqlDbType.VarChar, 10) : ITEMCODE.Direction = ParameterDirection.Input : ITEMCODE.Value = txtItemCode.Text : Params(2) = ITEMCODE
        '    Dim LOTNO As New SqlParameter("@LOTNO", SqlDbType.VarChar, 10) : LOTNO.Direction = ParameterDirection.Input : LOTNO.Value = txtLotNo.Text : Params(3) = LOTNO
        ...
        '    BusinessObject.Sub_Insert(ServerPath2, "DReceive_Update", CommandType.StoredProcedure, Params)
        '    LogHelper.InsertLog("DReceive_Update")
        'Catch ex As Exception
        '    MsgBox(ex.Message)
        '    LogHelper.InsertLog("DReceive_Update.Error: " & ex.Message)
        'End Try
        MsgBox("Update of Received Inventory is not allowed.")
    End Sub
    Private Sub Sub_Show()
        Try
            ...
            Dim HRID As New SqlParameter("@HRID ", SqlDbType.Int, 10)
            HRID.Direction = ParameterDirection.Input
            HRID.Value = txtHRID.Text.ToString.Trim
            Params(0) = HRID
            BusinessObject.Sub_Show(ServerPath2, "DReceive_Show", CommandType.StoredProcedure, RemoteDataSet, "ProductFormCT_Show", Params)
            ...
            LogHelper.InsertLog("DReceive_Show.Success")
        Catch ex As Exception
            MsgBox(ex.Message)
            LogHelper.InsertLog("DReceive_Show.Error: " & ex.Message)
        End Try
    ...
    Private Sub Sub_Select(ByVal dbParams() As String, ByVal UpdateMode As String)
        ...
        Select Case UpdateMode
            Case "Insert"
                Dim BusinessObject As New BusinessLayer.clsFileMaintenance
                myRowid = CInt(BusinessObject.Sub_ReturnIntegerResult(ServerPath2, "DReceive_GetInsertedRowid", CommandType.StoredProcedure))
            Case "Update"
    ...
    '    End Try
    'End Sub
    Private Sub frmDReceive_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
