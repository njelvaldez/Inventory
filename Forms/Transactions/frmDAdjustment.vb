...
Public Class frmDAdjustment
    ...
    Private Sub cmdEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdEdit.Click
        'modControlBehavior.EnableControlsGroup(Me, True)
        'If txtAdjNo.Text = "" And txtItemDesc.Text = "" Then
        ...
        '    txtQty.Focus()
        'End If
        MsgBox("Update of Inventory Adjustment is not allowed!")
    End Sub
    Private Sub cmdDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdDelete.Click
        ...
        '    End If
        'End If
        MsgBox("Deletion of Inventory Adjusment is not allowed!")
    End Sub
    ...
    Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        ...
        If EditMode = False Then
            If AllValidFields() Then
                ...
                StkcardIMSAdjustment(txtLocCode.Text, txtItemCode.Text, txtLotNo.Text, dtexpdate.Value, txtQty.Text)
            Else
    ...
    Private Function AllValidFields() As Boolean
        ...
        If txtAdjNo.Text.ToString <> "" And txtLocCode.Text.ToString <> "" And _
    ...
    Private Sub Sub_Insert()
        Try
            ...
            Dim HAID As New SqlParameter("@HAID", SqlDbType.Int, 10) : HAID.Direction = ParameterDirection.Input : HAID.Value = Convert.ToInt16(txtHAid.Text) : Params(0) = HAID
            ...
            Dim REMARKS As New SqlParameter("@REMARKS", SqlDbType.VarChar, 25) : REMARKS.Direction = ParameterDirection.Input : REMARKS.Value = txtRemarks.Text : Params(7) = REMARKS
            BusinessObject.Sub_Insert(ServerPath2, "DAdjust_Insert", CommandType.StoredProcedure, Params)
            LogHelper.InsertLog("DAdjust_Insert")
        Catch ex As Exception
            MsgBox(ex.Message)
            LogHelper.InsertLog("DAdjust_Insert.Error: " & ex.Message)
        End Try
    ...
    Private Sub Sub_Update()
        ...
        '    Dim BusinessObject As New BusinessLayer.clsFileMaintenance
        '    Dim Params(7) As SqlParameter
        '    Dim HAID As New SqlParameter("@HAID", SqlDbType.Int, 10) : HAID.Direction = ParameterDirection.Input : HAID.Value = txtHAid.Text : Params(0) = HAID
        '    Dim LOCCODE As New SqlParameter("@LOCCODE", SqlDbType.VarChar, 5) : LOCCODE.Direction = ParameterDirection.Input : LOCCODE.Value = txtLocCode.Text : Params(1) = LOCCODE
        '    Dim ITEMCODE As New SqlParameter("@ITEMCODE", SqlDbType.VarChar, 10) : ITEMCODE.Direction = ParameterDirection.Input : ITEMCODE.Value = txtItemCode.Text : Params(2) = ITEMCODE
        '    Dim LOTNO As New SqlParameter("@LOTNO", SqlDbType.VarChar, 10) : LOTNO.Direction = ParameterDirection.Input : LOTNO.Value = txtLotNo.Text : Params(3) = LOTNO
        ...
        '    BusinessObject.Sub_Insert(ServerPath2, "DAdjust_Update", CommandType.StoredProcedure, Params)
        '    LogHelper.InsertLog("DAdjust_Update")
        'Catch ex As Exception
        '    MsgBox(ex.Message)
        '    LogHelper.InsertLog("DAdjust_Update.Error: " & ex.Message)
        'End Try
        MsgBox("Update of Inventory Adjustment is not allowed.")
    End Sub
    Private Sub Sub_Show()
        Try
            ...
            Dim HAID As New SqlParameter("@HAID ", SqlDbType.Int, 10)
            HAID.Direction = ParameterDirection.Input
            HAID.Value = txtHAid.Text.ToString.Trim
            Params(0) = HAID
            BusinessObject.Sub_Show(ServerPath2, "DAdjust_Show", CommandType.StoredProcedure, RemoteDataSet, "ProductFormCT_Show", Params)
            ...
            LogHelper.InsertLog("DAdjust_Show.Success")
        Catch ex As Exception
            MsgBox(ex.Message)
            LogHelper.InsertLog("DAdjust_Show.Error: " & ex.Message)
        End Try
    ...
    Private Sub Sub_Select(ByVal dbParams() As String, ByVal UpdateMode As String)
        ...
        Select Case UpdateMode
            Case "Insert"
                Dim BusinessObject As New BusinessLayer.clsFileMaintenance
                myRowid = CInt(BusinessObject.Sub_ReturnIntegerResult(ServerPath2, "DAdjust_GetInsertedRowid", CommandType.StoredProcedure))
            Case "Update"
    ...
    '    End Try
    'End Sub
    Private Sub frmDAdjustment_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub DataGrid1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgPODetail.Click, dgPODetail.CurrentCellChanged
        Try
            With dgPODetail
                ...
                txtRemarks.Text = CStr(.Item(.CurrentCell.RowNumber, 11))
